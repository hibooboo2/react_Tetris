            ...
            React.createElement("div", {className: "GameBox"},
                ...
                React.createElement("div", null,
                    React.createElement("div", {className: "previewBox "+(this.state.gameState.settings.canPreview ? "enabled":"disabled")},
                            ...
                            "Next Piece:",
                            React.createElement("div", {style: {position:"absolute",top:"0em"}}, this.drawPiece(this.state.gameState.pieceEngine.que.slice(0).reverse()[0])),

                            React.createElement("div", {style: {position:"absolute",top:"8em"}}, this.drawPiece(this.state.gameState.pieceEngine.que.slice(0).reverse()[1]))
                    ),
                ...
                React.createElement("div", {id: "chat_Box"},
